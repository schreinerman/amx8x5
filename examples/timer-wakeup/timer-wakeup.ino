...
void setup () {
    ...
    // setup countdown timer every 60s periodically
    rtc.setCountdown(AMx8x5::enPeriodeRange::AMx8x5PeriodeSeconds, 60, AMx8x5::enCountdownInterruptOutput::AMx8x5RepeatModeRepeatedPulseLong, AMx8x5::enCountdownInterruptPin::AMx8x5CountdownInterruptPinnTIRQLow); 
    rtc.getTime(&pMyTime);
...
void loop(void)
{
  ...
  } else
  {
    ...
    {
        Serial.println("Timer IRQ was generated!");
